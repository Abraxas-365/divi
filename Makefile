...
export POSTGRES_DB = dividb
export POSTGRES_USER = divi
...
export JWT_ISSUER = divi
export JWT_AUDIENCE = divi-api,divi-web

# ============================================================================
# Environment Variables - API Key Configuration
# ============================================================================

export API_KEY_LIVE_PREFIX = divi_live
export API_KEY_TEST_PREFIX = divi_test
...
export AWS_BUCKET = divi-uploads
...
REDIS_CONTAINER_NAME = divi-redis
